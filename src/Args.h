...
namespace argparse {
    ...
    public:
        ...
        virtual void prolog() {}       // Allow to overwrite the `prolog` function to add a prolog-message to the help output
        virtual void epilog() {}      // Allow to overwrite the `epilog` function to add a epilog-message to the help output
        virtual void help() {
            prolog();
